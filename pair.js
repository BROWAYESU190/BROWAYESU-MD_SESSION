    ...
    async function startPairing() {
        try {
            ...
            sock.ev.on('connection.update', async ({ connection, lastDisconnect }) => {  
                if (connection === 'open') {  
                    console.log('✅ BROWAYESU-MD successfully connected to WhatsApp.');  
...
> Owner:
https://wa.me/254746432359



> WaGroup:
https://chat.whatsapp.com/K8mKWGWLrYi4hSGZvb8PIK?mode=hqrt3



> WaChannel:
https://whatsapp.com/channel/0029Vb6YML80VycDvHq6yV3S
